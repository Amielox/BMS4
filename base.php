...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      <div class="pic"><img src="assets/img/LOGO.png" class="img-fluid" alt="" style="width:55px; height:55px; margin-right:10px;"></div>
      <h1 class="logo me-auto"><a href="#">BARANGAY CULIAT</a></h1>
      <!-- Uncomment below if you prefer to use an image logo -->
      <!-- <a href="index.html" class="logo me-auto"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>-->
      
      <nav id="navbar" class="navbar">
        <ul>
          <li><a href="login/logout.php" class="getstarted scrollto" style="background-color: #37517e">Log Out</a></li>
        </ul>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-4  " data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              <div class="icon"><i class="bx bx-file"></i></div>
              <h4><a href="CBForm.php">Vaccine and Booster</a></h4>
            </div>
          </div>
        </div>
